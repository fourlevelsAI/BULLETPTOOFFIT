...
const advancedFeatures = [
  ...
  { title: "AI Recipe Generation", desc: "Get personalized meal recipes generated by AI based on your calorie goals, dietary preferences and fitness targets.", icon: ChefHat },
];
        ...
        <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-12 items-center relative z-10">
          <motion.div variants={stagger} initial="hidden" animate="show">
            ...
            <motion.h1 variants={fadeUp}
              ...
              <span className="text-white font-black" style={{ opacity: 1 }}>AI FITNESS</span>
              <br />
              <span className="text-white font-black" style={{ opacity: 1 }}>COACHING</span>
              <br />
